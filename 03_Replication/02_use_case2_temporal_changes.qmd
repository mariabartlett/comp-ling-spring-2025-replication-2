...
cr_data1 <- readRDS("data/corpus_full_cr_pre45.rds")
cr_data2 <- readRDS("data/corpus_full_cr_post45.rds")
cr_data <- rbind(cr_data1, cr_data2)
cr_data <- cr_data %>% select(speech, period_start, period_end) %>% distinct(speech, .keep_all = TRUE) %>% tidyr::drop_na()

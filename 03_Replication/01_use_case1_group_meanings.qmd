...
### Analysis 2. Differences by party
...
ncs_D <- ncs(x = immig_wv_party["D",], contexts_dem = immig_dem[immig_dem@docvars$party == "D",], contexts = immig_toks[docvars(immig_toks, 'party') == "D",], N = 5, as_list = FALSE)
ncs_R <- ncs(x = immig_wv_party["R",], contexts_dem = immig_dem[immig_dem@docvars$party == "R",], contexts = immig_toks[docvars(immig_toks, 'party') == "R",], N = 5, as_list = FALSE)
